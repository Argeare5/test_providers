...
export declare namespace IVotingMachineWithProofs {
  ...
  export type CreateInputStructOutput = [BigNumber, number, number, string] & {
...
export interface IVotingMachineWithProofsInterface extends utils.Interface {
  functions: {
    ...
    "create((uint256,uint24,uint40,bytes32))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [IVotingMachineWithProofs.CreateInputStruct]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "ProposalVoteClosed(uint256)": EventFragment;
...
export interface IVotingMachineWithProofs extends BaseContract {
  ...
  functions: {
    ...
    create(
      input: IVotingMachineWithProofs.CreateInputStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
